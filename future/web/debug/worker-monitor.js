// Lightweight worker registry and stats collector for debug UI
...
// convenience globals for quick debugging from console/tests
if (typeof window !== 'undefined') {
  try {
    window.__acoustseeRegisterWorker = registerWorker;
    window.__acoustseeUnregisterWorker = unregisterWorker;
    window.__acoustseeGetWorkerStats = getWorkerStats;
  } catch (e) {}
}
